...
class NoReferencesBot(object):
    ...
    def __init__(self, generator, always=False, verbose=True, site=pywikibot.getSite()):
        ...
        try:
            ...
            self.referencesTemplates = referencesTemplates['wikipedia']['en']
        try:
...
if __name__ == "__main__" and pywikibot.handleUrlAndHeader():
    try:
        pywikibot.startContent(form=True)
        main()
    finally:
        pywikibot.endContent()
        pywikibot.stopme()
